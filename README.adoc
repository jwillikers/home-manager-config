...
Fedora Atomic::
+
.. Add the InputPlumber COPR repository to your system.
+
[,sh]
----
curl --location https://copr.fedorainfracloud.org/coprs/shadowblip/InputPlumber/repo/fedora-42/shadowblip-InputPlumber-fedora-42.repo \
  | sudo tee /etc/yum.repos.d/shadowblip-InputPlumber-fedora-42.repo
----

.. Install the `inputplumber` package.
+
[,sh]
----
...
.. Enable and start the InputPlumber service.
+
[,sh]
----
