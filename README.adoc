...
// todo Install KDE wallet integration things such as ksshaskpass and related autostart service
// todo Fix colorscheme for konsole
...
// todo Add user to trusted-users in nix.conf
...
[,sh]
----
mkdir --parents /nix/var/cache/ccache
----
